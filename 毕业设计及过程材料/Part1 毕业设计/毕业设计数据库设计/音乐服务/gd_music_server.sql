/*
 ...
 Source Schema         : gd_music_server

 Target Server Type    : MySQL
 Target Server Version : 50719
 File Encoding         : 65001

 Date: 30/05/2018 00:20:48
*/
...
CREATE TABLE `artist` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '艺人ID',
...
CREATE TABLE `like_comment` (
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='点赞评论表';
...
CREATE TABLE `listen_history` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '历史听歌记录id',
  `user_id` bigint(20) NOT NULL COMMENT '用户id',
  `music_id` bigint(20) NOT NULL COMMENT '音乐id',
  `listened_time` datetime NOT NULL COMMENT '收听时间',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modified_time` datetime NOT NULL COMMENT '最近修改时间',
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='历史听歌记录表';
...
CREATE TABLE `music_comment` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '歌曲评论id',
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='歌曲评论表';
...
CREATE TABLE `music_in_user_music_list` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '歌单内歌曲id',
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户歌单内歌曲表';
...
CREATE TABLE `music_list_collection` (
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户收藏的歌单表';
...
CREATE TABLE `special` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '专辑id',
...
) ENGINE=InnoDB AUTO_INCREMENT=100008 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户表';
...
CREATE TABLE `user_music_list` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户歌单表主键id',
  ...
  `is_delete` tinyint(4) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户歌单表';
